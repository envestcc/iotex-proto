...
func (RewardType) Descriptor() protoreflect.EnumDescriptor {
	return file_proto_types_action_proto_enumTypes[2].Descriptor()
}

func (RewardType) Type() protoreflect.EnumType {
	return &file_proto_types_action_proto_enumTypes[2]
}
...
type Candidate struct {
	...
	Type          CandidateType `protobuf:"varint,5,opt,name=type,proto3,enum=iotextypes.CandidateType" json:"type,omitempty"`
}
...
type CandidateBasicInfo struct {
	...
	Type            CandidateType `protobuf:"varint,4,opt,name=type,proto3,enum=iotextypes.CandidateType" json:"type,omitempty"`
}
...
func (x *CandidateBasicInfo) GetType() CandidateType {
	if x != nil {
		return x.Type
	}
	return CandidateType_ConsensusCandidate
...
var file_proto_types_action_proto_rawDesc = []byte{
	...
	0x61, 0x64, 0x22, 0xa8, 0x01, 0x0a, 0x09, 0x43, 0x61, 0x6e, 0x64, 0x69, 0x64, 0x61, 0x74, 0x65,
	...
	0x0d, 0x72, 0x65, 0x77, 0x61, 0x72, 0x64, 0x41, 0x64, 0x64, 0x72, 0x65, 0x73, 0x73, 0x12, 0x2d,
	0x0a, 0x04, 0x74, 0x79, 0x70, 0x65, 0x18, 0x05, 0x20, 0x01, 0x28, 0x0e, 0x32, 0x19, 0x2e, 0x69,
	0x6f, 0x74, 0x65, 0x78, 0x74, 0x79, 0x70, 0x65, 0x73, 0x2e, 0x43, 0x61, 0x6e, 0x64, 0x69, 0x64,
	0x61, 0x74, 0x65, 0x54, 0x79, 0x70, 0x65, 0x52, 0x04, 0x74, 0x79, 0x70, 0x65, 0x22, 0x46, 0x0a,
	...
	0x70, 0x61, 0x79, 0x6c, 0x6f, 0x61, 0x64, 0x22, 0xa7, 0x01, 0x0a, 0x12, 0x43, 0x61, 0x6e, 0x64,
	...
	0x73, 0x73, 0x12, 0x2d, 0x0a, 0x04, 0x74, 0x79, 0x70, 0x65, 0x18, 0x04, 0x20, 0x01, 0x28, 0x0e,
	0x32, 0x19, 0x2e, 0x69, 0x6f, 0x74, 0x65, 0x78, 0x74, 0x79, 0x70, 0x65, 0x73, 0x2e, 0x43, 0x61,
	0x6e, 0x64, 0x69, 0x64, 0x61, 0x74, 0x65, 0x54, 0x79, 0x70, 0x65, 0x52, 0x04, 0x74, 0x79, 0x70,
	0x65, 0x22, 0xf9, 0x01, 0x0a, 0x11, 0x43, 0x61, 0x6e, 0x64, 0x69, 0x64, 0x61, 0x74, 0x65, 0x52,
	...
	,
...
var file_proto_types_action_proto_enumTypes = make([]protoimpl.EnumInfo, 3)
...
var file_proto_types_action_proto_goTypes = []interface{}{
	(CandidateType)(0),                // 0: iotextypes.CandidateType
	(Encoding)(0),                     // 1: iotextypes.Encoding
	(RewardType)(0),                   // 2: iotextypes.RewardType
	(*Transfer)(nil),                  // 3: iotextypes.Transfer
	(*Candidate)(nil),                 // 4: iotextypes.Candidate
	(*CandidateList)(nil),             // 5: iotextypes.CandidateList
	(*PutPollResult)(nil),             // 6: iotextypes.PutPollResult
...
var file_proto_types_action_proto_depIdxs = []int32{
	0,  // 0: iotextypes.Candidate.type:type_name -> iotextypes.CandidateType
	4,  // 1: iotextypes.CandidateList.candidates:type_name -> iotextypes.Candidate
	5,  // 2: iotextypes.PutPollResult.candidates:type_name -> iotextypes.CandidateList
	8,  // 3: iotextypes.Execution.accessList:type_name -> iotextypes.AccessTuple
	0,  // 4: iotextypes.CandidateBasicInfo.type:type_name -> iotextypes.CandidateType
	15, // 5: iotextypes.CandidateRegister.candidate:type_name -> iotextypes.CandidateBasicInfo
	19, // 6: iotextypes.PutBlock.roots:type_name -> iotextypes.MerkleRoot
	46, // 7: iotextypes.PlumPutBlock.roots:type_name -> iotextypes.PlumPutBlock.RootsEntry
	3,  // 8: iotextypes.ActionCore.transfer:type_name -> iotextypes.Transfer
	7,  // 9: iotextypes.ActionCore.execution:type_name -> iotextypes.Execution
	17, // 10: iotextypes.ActionCore.startSubChain:type_name -> iotextypes.StartSubChain
	18, // 11: iotextypes.ActionCore.stopSubChain:type_name -> iotextypes.StopSubChain
	20, // 12: iotextypes.ActionCore.putBlock:type_name -> iotextypes.PutBlock
	21, // 13: iotextypes.ActionCore.createDeposit:type_name -> iotextypes.CreateDeposit
	22, // 14: iotextypes.ActionCore.settleDeposit:type_name -> iotextypes.SettleDeposit
	23, // 15: iotextypes.ActionCore.createPlumChain:type_name -> iotextypes.CreatePlumChain
	24, // 16: iotextypes.ActionCore.terminatePlumChain:type_name -> iotextypes.TerminatePlumChain
	25, // 17: iotextypes.ActionCore.plumPutBlock:type_name -> iotextypes.PlumPutBlock
	26, // 18: iotextypes.ActionCore.plumCreateDeposit:type_name -> iotextypes.PlumCreateDeposit
	27, // 19: iotextypes.ActionCore.plumStartExit:type_name -> iotextypes.PlumStartExit
	28, // 20: iotextypes.ActionCore.plumChallengeExit:type_name -> iotextypes.PlumChallengeExit
	29, // 21: iotextypes.ActionCore.plumResponseChallengeExit:type_name -> iotextypes.PlumResponseChallengeExit
	30, // 22: iotextypes.ActionCore.plumFinalizeExit:type_name -> iotextypes.PlumFinalizeExit
	31, // 23: iotextypes.ActionCore.plumSettleDeposit:type_name -> iotextypes.PlumSettleDeposit
	32, // 24: iotextypes.ActionCore.plumTransfer:type_name -> iotextypes.PlumTransfer
	43, // 25: iotextypes.ActionCore.depositToRewardingFund:type_name -> iotextypes.DepositToRewardingFund
	44, // 26: iotextypes.ActionCore.claimFromRewardingFund:type_name -> iotextypes.ClaimFromRewardingFund
	45, // 27: iotextypes.ActionCore.grantReward:type_name -> iotextypes.GrantReward
	9,  // 28: iotextypes.ActionCore.stakeCreate:type_name -> iotextypes.StakeCreate
	10, // 29: iotextypes.ActionCore.stakeUnstake:type_name -> iotextypes.StakeReclaim
	10, // 30: iotextypes.ActionCore.stakeWithdraw:type_name -> iotextypes.StakeReclaim
	11, // 31: iotextypes.ActionCore.stakeAddDeposit:type_name -> iotextypes.StakeAddDeposit
	12, // 32: iotextypes.ActionCore.stakeRestake:type_name -> iotextypes.StakeRestake
	13, // 33: iotextypes.ActionCore.stakeChangeCandidate:type_name -> iotextypes.StakeChangeCandidate
	14, // 34: iotextypes.ActionCore.stakeTransferOwnership:type_name -> iotextypes.StakeTransferOwnership
	16, // 35: iotextypes.ActionCore.candidateRegister:type_name -> iotextypes.CandidateRegister
	15, // 36: iotextypes.ActionCore.candidateUpdate:type_name -> iotextypes.CandidateBasicInfo
	6,  // 37: iotextypes.ActionCore.putPollResult:type_name -> iotextypes.PutPollResult
	33, // 38: iotextypes.Action.core:type_name -> iotextypes.ActionCore
	1,  // 39: iotextypes.Action.encoding:type_name -> iotextypes.Encoding
	34, // 40: iotextypes.Actions.actions:type_name -> iotextypes.Action
	37, // 41: iotextypes.Receipt.logs:type_name -> iotextypes.Log
	37, // 42: iotextypes.Logs.logs:type_name -> iotextypes.Log
	39, // 43: iotextypes.EvmTransferList.evmTransfers:type_name -> iotextypes.EvmTransfer
	39, // 44: iotextypes.ActionEvmTransfer.evmTransfers:type_name -> iotextypes.EvmTransfer
	41, // 45: iotextypes.BlockEvmTransfer.actionEvmTransfers:type_name -> iotextypes.ActionEvmTransfer
	2,  // 46: iotextypes.GrantReward.type:type_name -> iotextypes.RewardType
